...
높은 우선순위 Pod가 낮은 우선순위 Pod에 **affinity**가 있으면?
...
PodDisruptionBudget을 **존중하려고 노력**하지만 보장 아님
...
| **GPU 세부 정보** | `nvidia.com/gpu: 1`만 앎. 어떤 GPU인지 모름 |
